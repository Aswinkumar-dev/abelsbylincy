...
export default function FaqPage() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      items: [
        { q: 'What is your return policy?', a: 'We offer a 7-day easy change-of-mind return policy on unworn, unaltered items in original packaging. Items showing signs of wear are not eligible for change-of-mind returns. Your statutory rights under Australian Consumer Law always apply.' },
